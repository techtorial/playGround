...
public class ReggTest {

    @Test
    public void regTest() throws IOException, URISyntaxException {
        ReggPojo registerPOJO = new ReggPojo();
        ...
        ReggPojo user = objectMapper.readValue(response.getEntity().getContent(), ReggPojo.class);
