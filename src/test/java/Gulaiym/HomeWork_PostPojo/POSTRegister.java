...
public class POSTRegister {
    ...
    public void registerUser() throws IOException, URISyntaxException {
        ...
        objectMapper.writeValue(new File("src/test/java/Gulaiym/HomeWork_PostPojo/register.json"), register);
    ...
    public void loginUser() throws IOException, URISyntaxException {
        ...
        objectMapper.enable(SerializationConfig.Feature.INDENT_OUTPUT);
        objectMapper.writeValue(new File("src/test/java/Gulaiym/HomeWork_PostPojo/login.json"), register);
    ...
    public void updateUser() throws IOException, URISyntaxException {
        RegisterPojo register = new RegisterPojo("gulya.dzh@reqres.in","pistol");
        register.setUpdatedAt("2019-12-24T01:38:54.089Z");

        ObjectMapper objectMapper = new ObjectMapper();
        objectMapper.enable(SerializationConfig.Feature.INDENT_OUTPUT);
        objectMapper.writeValue(new File("src/test/java/Gulaiym/HomeWork_PostPojo/update.json"), register);
